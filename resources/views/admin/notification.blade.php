...
@section('content')
    ...
    <main id="main">
        <div class="card col-6">
            <div class="card-header">LISTE laptop renvoyer</div>
            <div class="card-body">
                    ...
                    <table class="table">
                        ...
                        @foreach($renvois as $res)
                            <tr class="bg-blue">
                                ...
                                <td class="pt-3"><button class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#{{ $res->id_renvoi }}"><i class="bi bi-pen-fill"></i>RECEVOIR</button></td>
...
@foreach($renvois as $res)
    <div class="modal fade" id="{{ $res->id_renvoi }}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('saveReceptionMag',['id_laptop'=>$res->id_laptop,'id_pointdevente'=>$res->id_pointdevente,'id_renvoi'=>$res->id_renvoi]) }}" method="POST" class=" g-3">
                    <div class="modal-body">
                        <input type="hidden" name="id_utilisateur" value="{{ $res->id_utilisateur }}">
